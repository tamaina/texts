...
「連合のinboxに投稿を送信する」「連合のファイルを取ってくる」など、Misskeyサーバーから外に向かって通信をすると、アクセス先のサーバーにIPアドレスを教えなくてはなりません。  
ActivityPubの仕様上、インスタンス運営者でなくとも[簡単にサーバーのIPアドレスを入手](https://gist.github.com/cutiful/4f36da3ed37b24f9a7106064393f5e7f)できてしまいます。
